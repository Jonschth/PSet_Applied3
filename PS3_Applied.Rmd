...
type %>% 
  head(100) %>% 
  filter(str_detect(participant_type, "Subject-Suspect", negate=FALSE))
...
CENSUS_KEY <- Sys.getenv("7b144a5d849b2f47475f9c1e44514c692f0246d0")
...
TopMap <- Top15 %>% select(latitude, longitude, Victims, City, Location)
